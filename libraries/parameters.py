...
class parameters:
    def __init__(self):
        ...
        We do not consider the pipelining latency, therefore the time is only the average throughput
        '''
        self.time_step= 100
        self.NrPhysicalCore4Cores = 1
        self.NrPhysicalCore4Buses = 1
        self.queue_depths = [6400,6400]
        self.N_NPE = 4
        self.mesh_size = [32,32] # size of the HW [col, row]
