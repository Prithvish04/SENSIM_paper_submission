...
class PilotNet_app_singleflit():
    def __init__(self, simObj):
        self.sim = simObj
        
        # define experiment specific parameters
        from DNNs.PilotNet.evcompress_experiment.sensim_app.parameters import parameters
        self.sim.param = parameters()

        self.sim.output_dir = "DNNs/PilotNet/evcompress_experiment/outputs/outputs_singleflit/"
...
class PilotNet_app_multiflit(): #1 flit header, then 4 spikes per flit, max 32 flit
    def __init__(self, simObj):
        self.sim = simObj
        ...
        self.sim.output_dir = "DNNs/PilotNet/evcompress_experiment/outputs/outputs_multiflit/"
        os.makedirs(self.sim.output_dir, exist_ok=True) 
        ...
        #Multi spike packet
        self.sim.param.flit_width = 32 #number of bits per flits        
        self.sim.param.max_event_flits = 32 # limit the max number of flits per event
