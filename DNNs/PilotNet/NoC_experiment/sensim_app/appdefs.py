...
class PilotNet_app():
    def __init__(self, simObj, multicast=1):
        self.sim = simObj
        
        # define experiment specific parameters
        from DNNs.PilotNet.NoC_experiment.sensim_app.parameters import parameters
        self.sim.param = parameters()
        self.sim.param.multicast=multicast

        if self.sim.param.multicast==1:
            self.sim.output_dir = "DNNs/PilotNet/NoC_experiment/outputs/outputs_multicast/"
        else:
            self.sim.output_dir = "DNNs/PilotNet/NoC_experiment/outputs/outputs_unicast/"
        os.makedirs(self.sim.output_dir, exist_ok=True) 
        
        #Timing
        self.sim.simulation_end_time = 9000e6
