...
class PilotNet_app():
    def __init__(self, simObj, Spike_Register=8):
        self.sim = simObj
        # Modify experiment specific parameters
        from DNNs.PilotNet.RegFile_experiment.sensim_app.parameters import parameters
        self.sim.output_dir = "DNNs/PilotNet/RegFile_experiment/outputs/outputs_"+str(Spike_Register)+"/"
        ...
        #HW
        self.sim.param.Spike_Register = Spike_Register # <-NOTE-- Experiment is about this parameter
