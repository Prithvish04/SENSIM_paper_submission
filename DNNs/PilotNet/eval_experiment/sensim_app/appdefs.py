...
class PilotNet_app():
    def __init__(self, simObj, sync_type='TimeStep_flag'):
        self.sim = simObj
        
        # define experiment specific parameters
        from DNNs.PilotNet.eval_experiment.sensim_app.parameters import parameters
        self.sim.param = parameters()
        self.sim.param.sync_type=sync_type

        self.sim.output_dir = "DNNs/PilotNet/eval_experiment/outputs/outputs_"+self.sim.param.sync_type+"/"
