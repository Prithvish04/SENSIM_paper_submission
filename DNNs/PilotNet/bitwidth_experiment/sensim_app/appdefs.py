...
class PilotNet_app():
    def __init__(self, simObj, Weights=4, States=16, Outputs=1):
        self.sim = simObj
        # Modify experiment specific parameters
        from DNNs.PilotNet.bitwidth_experiment.sensim_app.parameters import parameters
        self.sim.output_dir = "DNNs/PilotNet/bitwidth_experiment/outputs/outputs_"+str(Weights)+"_"+str(States)+"_"+str(Outputs)+"/"
